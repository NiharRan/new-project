...
namespace NewProject\Framework\Database\Orm\Relations;

use NewProject\Framework\Support\Arr;
use NewProject\Framework\Support\Str;
use NewProject\Framework\Database\Orm\Model;
use NewProject\Framework\Database\Orm\Builder;
use NewProject\Framework\Database\Orm\Collection;
use NewProject\Framework\Database\Orm\ModelHelperTrait;
use NewProject\Framework\Database\Orm\ModelNotFoundException;
...
class BelongsToMany extends Relation
{
     ...
     *
     * @param  \NewProject\Framework\Database\Orm\Builder  $query
     * @param  \NewProject\Framework\Database\Orm\Model  $parent
     * @param  string  $table
     ...
     * @return \NewProject\Framework\Database\Orm\Relations\BelongsToMany
     */
     ...
     *
     * @param  array  $columns
     * @return \NewProject\Framework\Database\Orm\Model|static
     *
     * @throws \NewProject\Framework\Database\Orm\ModelNotFoundException
     */
     ...
     *
     * @param  array  $columns
     * @return \NewProject\Framework\Database\Orm\Collection
     */
     ...
     * @param  int|null  $page
     * @return \NewProject\Framework\Contracts\Pagination\LengthAwarePaginator
     */
     ...
     * @param  array  $columns
     * @param  string  $pageName
     * @return \NewProject\Framework\Contracts\Pagination\Paginator
     */
     ...
     *
     * @param  \NewProject\Framework\Database\Orm\Builder  $query
     * @param  \NewProject\Framework\Database\Orm\Builder  $parent
     * @param  array|mixed  $columns
     * @return \NewProject\Framework\Database\Orm\Builder
     */
     ...
     *
     * @param  \NewProject\Framework\Database\Orm\Builder|null  $query
     * @return $this
     */
     ...
     *
     * @param  array   $models
     * @param  \NewProject\Framework\Database\Orm\Collection  $results
     * @param  string  $relation
     * @return array
     */
     ...
     *
     * @return \NewProject\Framework\Support\Collection
     */
     ...
     * @param  array  $joining
     * @param  bool   $touch
     * @return \NewProject\Framework\Database\Orm\Model
     */
     ...
     *
     * @param  \NewProject\Framework\Support\Collection|array  $models
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \NewProject\Framework\Database\Orm\Model|\NewProject\Framework\Database\Orm\Collection|null
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \NewProject\Framework\Database\Orm\Model|\NewProject\Framework\Database\Orm\Collection
     *
     * @throws \NewProject\Framework\Database\Orm\ModelNotFoundException
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \NewProject\Framework\Support\Collection|\NewProject\Framework\Database\Orm\Model
     */
     ...
     *
     * @param  \NewProject\Framework\Database\Orm\Collection|array  $ids
     * @return array
     */
     ...
     * @param  array  $attributes
     * @param  bool   $exists
     * @return \NewProject\Framework\Database\Orm\Relations\Pivot
     */
