...
use NewProject\Framework\Pagination\Paginator;
use NewProject\Framework\Database\Query\Expression;
use NewProject\Framework\Pagination\LengthAwarePaginator;
...
class Builder
{
     ...
     *
     * @var \NewProject\Framework\Database\Query\Builder
     */
    protected $query;
     ...
     *
     * @var \NewProject\Framework\Database\Orm\Model
     */
    protected $model;
     ...
     * @param  \NewProject\Framework\Database\Orm\Scope|\Closure  $scope
     * @return $this
     */
     ...
     *
     * @param  \NewProject\Framework\Database\Orm\Scope|string  $scope
     * @return $this
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \NewProject\Framework\Database\Orm\Model|\NewProject\Framework\Database\Orm\Collection|static[]|static|null
     */
     ...
     *
     * @param  array  $columns
     * @return \NewProject\Framework\Database\Orm\Model|static|null
     */
     ...
     *
     * @param  array  $columns
     * @return \NewProject\Framework\Database\Orm\Collection|static[]
     */
     ...
     *
     * @param  string  $name
     * @return \NewProject\Framework\Database\Orm\Relations\Relation
     */
     ...
     * @param  string  $operator
     * @param  mixed   $value
     * @return \NewProject\Framework\Database\Orm\Builder|static
     */
     ...
     *
     * @param  \NewProject\Framework\Database\Orm\Builder  $hasQuery
     * @param  \NewProject\Framework\Database\Orm\Relations\Relation  $relation
     * @param  string  $operator
     * @param  int  $count
     * @param  string  $boolean
     * @return \NewProject\Framework\Database\Orm\Builder|static
     ...
     *
     * @param  \NewProject\Framework\Database\Orm\Builder  $relation
     * @return \NewProject\Framework\Database\Orm\Builder|static
     */
