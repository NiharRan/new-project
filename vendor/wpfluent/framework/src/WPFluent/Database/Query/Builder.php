...
namespace NewProject\Framework\Database\Query;
...
use NewProject\Framework\Support\Collection;
use NewProject\Framework\Pagination\Paginator;
use NewProject\Framework\Pagination\LengthAwarePaginator;
use NewProject\Framework\Support\MacroableTrait;
use NewProject\Framework\Database\Query\Grammar;
use NewProject\Framework\Database\Query\Processor;
use NewProject\Framework\Support\ArrayableInterface;
use NewProject\Framework\Database\ConnectionInterface;
...
class Builder
{
     ...
     *
     * @var \NewProject\Framework\Database\Query\WPDBConnection
     */
     ...
     *
     * @var \NewProject\Framework\Database\Query\Grammar
     */
    protected $grammar;
     ...
     *
     * @var \NewProject\Framework\Database\Query\Processor
     */
    protected $processor;
     ...
     *
     * @param  \NewProject\Framework\Database\ConnectionInterface  $connection
     * @param  \NewProject\Framework\Database\Query\Grammar  $grammar
     * @param  \NewProject\Framework\Database\Query\Processor  $processor
     * @return void
     */
     ...
     * @return \NewProject\Framework\Database\Query\Builder|static
     */
     ...
     *
     * @param  \Closure|\NewProject\Framework\Database\Query\Builder|string $query
     * @param  string  $as
     * @return \NewProject\Framework\Database\Query\Builder|static
     *
     ...
     *
     * @param  \NewProject\Framework\Database\Query\Builder|static $query
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \NewProject\Framework\Database\Query\Builder|\Closure  $query
     * @param  bool  $all
     * @return \NewProject\Framework\Database\Query\Builder|static
     */
     ...
     * @param  int|null  $page
     * @return \NewProject\Framework\Pagination\LengthAwarePaginatorInterface
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \NewProject\Framework\Pagination\PaginatorInterface
     */
     ...
     *
     * @param  mixed  $value
     * @return \NewProject\Framework\Database\Query\Expression
     */
     ...
     *
     * @return \NewProject\Framework\Database\ConnectionInterface
     */
     ...
     *
     * @return \NewProject\Framework\Database\Query\Processor
     */
     ...
     *
     * @return \NewProject\Framework\Database\Query\Grammar
     */
